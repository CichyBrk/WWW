...
<head>
	...
	<script type="text/javascript">
		...
		function checkData(){
			liczba = 1;
			if(checkElement("imie",/^[A-Z屍痌{1}[a-z规瓿耋繜淽{2,20}$/) == 0)
				{
					liczba = 0;
				}
			if(checkElement("nazwisko",/^[A-Z屍痌{1}[a-z规瓿耋繜淽{2,20}(-[A-Z／宂{1}[a-z规瓿耋繜淽{2,20})?$/) == 0)
				{
					liczba = 0;
				}
			...
			if(checkElement("miasto",/^[A-Z屍痌{1}[a-z规瓿耋繜淽{2,20}([ ][A-ZＦ瘜]{1}[a-z规瓿耋繜淽{2,20})?([-][A-ZＦ瘜]{1}[a-z规瓿耋繜淽{2,20})?([ ][A-ZＦ瘜]{1}[a-z规瓿耋繜淽{2,20})?(-[A-ZＦ瘜]{1}[a-z规瓿耋繜淽{2,20})?$/) == 0)
				{
					liczba = 0;
				}
			if(checkElement("ulica",/^[A-Z屍痌{1}[a-z规瓿耋繜淽{2,20}([ ][A-ZＦ瘜]{1}[a-z规瓿耋繜淽{2,20})?([-][A-ZＦ瘜]{1}[a-z规瓿耋繜淽{2,20})?([ ][A-ZＦ瘜]{1}[a-z规瓿耋繜淽{2,20})?(-[A-ZＦ瘜]{1}[a-z规瓿耋繜淽{2,20})?([ ][0-9]{1,5}[A-Z])?$/) == 0)
				{
					liczba = 0;
				}
